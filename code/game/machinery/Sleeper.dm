...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(list("morphine", "dexalin", "salglu_solution"),
								   list("morphine", "dexalin", "salglu_solution", "oculine"),
								   list("morphine", "dexalinplus", "salglu_solution", "oculine", "charcoal", "mutadone", "mannitol", "pen_acid"))
